...
REF_WORK_DIR_PATH="${HOME}/work/anduinos-iso-builder-remix-prototype-cinnamon"
...
echo "[Next Step]: cd ~/work/anduinos-iso-builder-remix-prototype-cinnamon/iso-profile
"
echo
